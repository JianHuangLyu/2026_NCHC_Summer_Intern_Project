...
| `server_endpoint/` | NCHC NANO4 的 `/work/<USER>/PathoVision_Server` | FastAPI、YOLO、學生模型、vLLM 啟動、Slurm、個案資料; 同時server_endpoint在放置NANO4, 資料夾需重新命名成`PathoVision_Server` | SSH 密碼、OTP、提交至 Git 的 token |
