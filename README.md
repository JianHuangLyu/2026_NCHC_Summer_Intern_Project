...
**應用:** 病理醫學影像異常區域準確定位與分析是影像判讀及臨床診斷重要基礎。
**問題:** 傳統病理影像仰賴醫師逐一閱片標註異常區域及撰寫分析報告，不僅耗費大量時間且易出錯
**處理:** 因此本專案提出基於病理影像異常區域偵測與教師引導學生技能最佳化之結構化分析方法，以利於後續改善病理影像判讀及分析之流程效率
...
涵蓋內容包括肺癌、乳癌、腎癌與淋巴結轉移相關病理醫學影像。上述數量是本專案經data augmentation與整理後的記錄數，不等同於 RefPath 官方公布的原始資料數目
